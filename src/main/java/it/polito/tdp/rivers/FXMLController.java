...
public class FXMLController {
    ...
    void doCheckRiver(ActionEvent event) {
    	...
    	List<Flow> flows = this.model.getFlowsByRiver(river.getId());
    	txtStartDate.appendText(flows.get(0).getDay() + "");
    	txtEndDate.appendText(flows.get(flows.size()-1).getDay() + "");
    ...
    public void setModel(Model model) {
    	this.model = model;
    	boxRiver.getItems().addAll(this.model.getAllRivers().values());
    }
}
